...
import com.tevinjeffrey.vapr.adapters.FilesFragmentAdapter;
import com.tevinjeffrey.vapr.adapters.ItemClickListener;
...
public class FilesFragment extends MVPFragment implements FilesView, ItemClickListener<CloudAppItem, android.view.View>, SwipeRefreshLayout.OnRefreshListener {
    ...
    public void initRecyclerView() {
        ...
        if (mRecyclerView.getAdapter() == null) {
            mRecyclerView.setAdapter(new FilesFragmentAdapter(mListDataSet, this));
        }
    }
    ...
    @Override
    public void onItemClicked(CloudAppItem data, android.view.View view) {
